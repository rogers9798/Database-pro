  ...
  <div class="w3-row-padding w3-text-white w3-large">
    <div class="w3-half w3-margin-bottom">
      <div class="w3-display-container">
        <img src="ac1.jpg" alt="Cinque Terre" style="width:100%">
        <span class="w3-display-bottomleft w3-padding" style="color:black">Ajanta Caves</span>
      </div>
    </div>
    <div class="w3-half">
      <div class="w3-row-padding" style="margin:0 -16px">
        <div class="w3-half w3-margin-bottom">
          <div class="w3-display-container">
            <img src="ac2.jpg" alt="New York" style="width:100%">
            <span class="w3-display-bottomleft w3-padding" style="color:black"></span>
          </div>
        </div>
        <div class="w3-half w3-margin-bottom">
          <div class="w3-display-container">
            <img src="ac3.jpg" alt="San Francisco" style="width:100%">
            <span class="w3-display-bottomleft w3-padding" style="color:black"></span>
          </div>
        </div>
      </div>
      <div class="w3-row-padding" style="margin:0 -16px">
        <div class="w3-half w3-margin-bottom">
          <div class="w3-display-container">
            <img src="ac6.jpg" alt="Pisa" style="width:100%">
            <span class="w3-display-bottomleft w3-padding" style="color:black"></span>
          </div>
        </div>
        <div class="w3-half w3-margin-bottom">
          <div class="w3-display-container">
            <img src="ac5.jpg" alt="Paris" style="width:100%">
            <span class="w3-display-bottomleft w3-padding" style="color:black"></span>
          </div>
        </div>
      </div>
...
<div>
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3735.8854980970173!2d75.70106341446548!3d20.55186530926397!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bd97f7014a75e43%3A0x7ca8d7c57639691f!2sAjanta+Caves!5e0!3m2!1sen!2sin!4v1542990259406" width="1200" height="400" frameborder="0" style="border:0" allowfullscreen></iframe>
  </div>
<br><br>
...
<?php 
	...
	echo " <div class='form-des'> <form method='POST' action='".setComments($conn)."'>
		<input class='inp-des' id='id-des' type='email' name='id' placeholder='Enter your email-id'> <br>
		<input class='inp-des' type='hidden' name='date' value='".date('Y-m-d H-i-s')."'> <br>
		<textarea class='inp-des' name='txt'> Write your review here </textarea> <br>
		<button class='inp-des' id='sub-des' name='com'> Post Review</button>
	</form> <br></div> <h2> All Comments </h2> <br> ";
	getComments($conn);
	?>
